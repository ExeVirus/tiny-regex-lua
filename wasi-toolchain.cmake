...
set(WASI_SDK_PREFIX /c/dev/wasm_testing/wasi-sdk)
...
set(CMAKE_C_FLAGS "-v -fvisibility=hidden -mnontrapping-fptoint" CACHE STRING "wasi-sdk build")
set(CMAKE_CXX_FLAGS "-v -std=c++11 -fvisibility=hidden -mnontrapping-fptoint" CACHE STRING "wasi-sdk build")
set(CMAKE_EXE_LINKER_FLAGS "-Wl,-z,stack-size=15728640,--allow-undefined,--export-dynamic" CACHE STRING "wasi-sdk build")
